...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.likeButton = QtWidgets.QPushButton(Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.likeButton.sizePolicy().hasHeightForWidth())
        self.likeButton.setSizePolicy(sizePolicy)
        self.likeButton.setObjectName("likeButton")
        self.gridLayout.addWidget(self.likeButton, 0, 1, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.likeButton.setText(_translate("Form", "收藏"))
