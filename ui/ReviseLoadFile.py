...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.selectionBox.setGeometry(QtCore.QRect(0, 0, 276, 137))
        ...
        self.objectQuestion = QtWidgets.QTextEdit(self.page0)
        self.objectQuestion.setObjectName("objectQuestion")
        self.gridLayout_2.addWidget(self.objectQuestion, 4, 0, 1, 4)
        self.objectExplanation = QtWidgets.QTextEdit(self.page0)
        self.objectExplanation.setObjectName("objectExplanation")
        self.gridLayout_2.addWidget(self.objectExplanation, 6, 3, 2, 1)
        ...
        self.subjectlabel_2 = QtWidgets.QLabel(self.page1)
        self.subjectlabel_2.setObjectName("subjectlabel_2")
        self.subjectLayout.addWidget(self.subjectlabel_2)
        self.subjectQuestion = QtWidgets.QTextEdit(self.page1)
